...
import static org.tquadrat.foundation.javadoc.internal.foundation.xml.builder.XMLBuilderUtils.composeXMLHeader;
 ...
 * {@link XMLDocument}.}</p>
 *  <p>It allows document comments and processing instructions to be added.</p>
 *
 *  @author Thomas Thrien - thomas.thrien@tquadrat.org
 *  @version $Id: XMLDocumentImpl.java 1133 2024-05-10 21:43:08Z tquadrat $
 *  @since 0.0.5
 */
@SuppressWarnings( {"ClassWithTooManyConstructors", "unused"} )
@ClassVersion( sourceVersion = "$Id: XMLDocumentImpl.java 1133 2024-05-10 21:43:08Z tquadrat $" )
...
public final class XMLDocumentImpl implements XMLDocument
{
    ...
    /**
     *  <p>{@summary Creates a new {@code XMLDocumentImpl} instance.}</p>
     *  <p>The resulting document will do not have an explicit doc type, the
     *  encoding is defined as UTF-8.</p>
     *
    ...
    public XMLDocumentImpl( final XMLElement rootElement, final boolean standalone )
    {
        ...
        addProcessingInstruction( composeXMLHeader( UTF_8, standalone ) );
    }   //  XMLDocumentBase()
    ...
    /**
     *  {@summary Creates a new {@code XMLDocumentImpl} instance.}
     *
     *  @param  rootElementName The name of the root element for this document.
     *  @param  encoding    The encoding for the new XML document.
     *  @param  uri The URI for the DTD.
     ...
     */
    @SuppressWarnings( "PublicMethodNotExposedInInterface" )
    public final void registerValidAttributes( final String... attributes ) throws InvalidXMLNameException
    {
