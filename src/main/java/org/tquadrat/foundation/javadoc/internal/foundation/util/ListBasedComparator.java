...
import org.tquadrat.foundation.javadoc.internal.ToolKit.KeyProvider;
 ...
 *  @version $Id: ListBasedComparator.java 1133 2024-05-10 21:43:08Z tquadrat $
 *  @since 0.0.5
 */
@ClassVersion( sourceVersion = "$Id: ListBasedComparator.java 1133 2024-05-10 21:43:08Z tquadrat $" )
...
public class ListBasedComparator<T,K> implements Comparator<T>
{
    ...
    public final int compare( final T o1, final T o2 )
    {
        ...
        if( o1 != o2 ) // Not identical …
        {
            ...
            else
            {
                ...
                {
                    /*
                     * That one that is closer to the beginning of the list is
     ...
     *      {@link ToolKit#NOT_FOUND}
     *      ({@value ToolKit#NOT_FOUND})
