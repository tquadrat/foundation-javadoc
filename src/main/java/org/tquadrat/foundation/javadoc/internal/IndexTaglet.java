...
/**
 *  <p>{@summary Re-implementation of the <code>{&#64;index}</code> taglet.}</p>
 *  <p>Unfortunately, it is not possible to access the original
 *  <code>{&#64;index}</code> taglet to process any tags inside a custom tag.
 *  That's why I created this replacement.</p>
 *
 *  @author Thomas Thrien - thomas.thrien@tquadrat.org
 *  @version $Id: IndexTaglet.java 1165 2026-03-22 19:30:59Z tquadrat $
 *  @since 0.0.5
 *
 *  @see CodeTaglet
 *  @see LiteralTaglet
 */
@ClassVersion( sourceVersion = "$Id: IndexTaglet.java 1165 2026-03-22 19:30:59Z tquadrat $" )
