...
import org.tquadrat.foundation.javadoc.internal.foundation.xml.builder.spi.Document;
...
public interface XMLDocument extends Document<XMLElement>
{
    ...
    /**
     *  <p>{@summary Adds predefined XML markup to the root element of this
     *  document.} The given markup will not be validated, it just may not be
    ...
    /**
     *  {@summary Sets the attribute with the given name to the root element of this
    ...
    /**
     *  <p>{@summary Sets the id for the root element of this document.}</p>
