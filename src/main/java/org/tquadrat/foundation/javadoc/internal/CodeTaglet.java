...
/**
 *  <p>{@summary Re-implementation of the well-known <code>{&#64;code}</code>
 *  taglet.}</p>
 *  <p>Unfortunately, it is not possible to access the original
 *  <code>{&#64;code}</code> taglet to process any tags inside a custom tag.
 *  That's why I created this replacement.</p>
 *
 *  @author Thomas Thrien - thomas.thrien@tquadrat.org
 *  @version $Id: CodeTaglet.java 978 2022-01-06 12:47:52Z tquadrat $
 *  @since 0.0.5
 *
 *  @see IndexTaglet
 *  @see LiteralTaglet
 */
@ClassVersion( sourceVersion = "$Id: CodeTaglet.java 978 2022-01-06 12:47:52Z tquadrat $" )
...
public final class CodeTaglet implements Taglet
{
    ...
    public final String toString( final List<? extends DocTree> tags, final Element element )
    {
        ...
        final var retValue = isNotEmptyOrBlank( contents ) ? format( "<code>%1$s</code>", escapeHTML( contents ) ) : EMPTY_STRING;
