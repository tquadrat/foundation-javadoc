...
/**
 *  Unfortunately, it is not possible to access the original {@code @code}
 *  taglet to process any tags inside a custom tag. Therefore we created this
 *  replacement.
 *
 *  @extauthor Thomas Thrien - thomas.thrien@tquadrat.org
 *  @version $Id: CodeTaglet.java 820 2020-12-29 20:34:22Z tquadrat $
 *  @since 0.0.5
 *
 *  @see IndexTaglet
 *  @see LiteralTaglet
 ...
 *  @UMLGraph.link
 */
@ClassVersion( sourceVersion = "$Id: CodeTaglet.java 820 2020-12-29 20:34:22Z tquadrat $" )
