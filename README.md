 ...
 * `@author` – A replacement for the default `@author` taglet that provides the author's email as a hyperlink.
...
- [Javadoc Reference](https://tquadrat.github.io/foundation-javadoc/javadoc/index.html)
  - Integration into Gradle
    ...
    Add the following stuff to your `build.gradle` file:
       ...
       *  documentation.
       */
     def tagList = ["hidden", "note", "param", "return", "throws", "author", 
         "extauthor", "thanks", "modified", "version", "since", "see",
         "inspired", "spec", "provides", "uses", "UMLGraph.link", "deprecated", 
         "todo", "apiNote:a:API Note:", "implSpec:a:Implementation Requirements:", 
